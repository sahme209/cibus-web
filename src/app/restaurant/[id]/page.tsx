  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg-secondary)" }}>
      ...
      <div className="relative h-56 sm:h-72 lg:h-80 overflow-hidden">
        ...
        {/* Share, Group Order & Save buttons */}
        <div className="absolute top-4 right-4 flex gap-2">
          ...
          <button
            onClick={() => {
              ...
              showToast("Group order link copied! Share with friends");
            }}
            className="h-10 px-3 rounded-full flex items-center gap-1.5 backdrop-blur-md transition-transform hover:scale-105"
            style={{ background: "rgba(0,0,0,0.3)" }}
