  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center px-4 py-8">
      ...
      <div
        ...
        style={{ background: "var(--bg-card)", boxShadow: "0 25px 50px -12px rgba(0,0,0,0.5)" }}
      >
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {mode === "signin" && (
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-full flex items-center justify-center" style={{ background: "var(--hubb-tint)" }}>
                  <svg className="w-3 h-3" style={{ color: "var(--hubb-accent)" }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="px-8 pb-8">
          {mode === "signin" ? (
            <>
              ...
              <div className="flex items-center gap-4 mb-5">
                ...
                <span className="text-xs font-medium" style={{ color: "var(--text-tertiary)" }}>or continue with email</span>
                <div className="flex-1 h-px" style={{ background: "var(--border-default)" }} />
              </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      border: fieldErrors.email ? "1.5px solid var(--hubb-orange)" : "1.5px solid var(--border-default)",
                    }}
                  />
                  ...
                  <div className="relative">
                    <input
                      ...
                      style={{
                        background: "var(--bg-search)",
                        color: "var(--text-primary)",
                        border: fieldErrors.password ? "1.5px solid var(--hubb-orange)" : "1.5px solid var(--border-default)",
                      }}
                    />
                    <button
                      type="button"
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                  ...
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      style={{
                        background: "var(--bg-search)",
                        color: "var(--text-primary)",
                        border: fieldErrors.name ? "1.5px solid var(--hubb-orange)" : "1.5px solid var(--border-default)",
                      }}
                    />
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      style={{
                        background: "var(--bg-search)",
                        color: "var(--text-primary)",
                        border: fieldErrors.phone ? "1.5px solid var(--hubb-orange)" : "1.5px solid var(--border-default)",
                      }}
                    />
                  </div>
                ...
                <p className="text-[11px] leading-relaxed" style={{ color: "var(--text-tertiary)" }}>
                  By tapping &ldquo;Sign Up&rdquo; or &ldquo;Continue with...&rdquo;, you agree to HUBB&apos;s{" "}
          ...
          {mode === "signin" && (
            <p className="text-[11px] text-center mt-5 leading-relaxed" style={{ color: "var(--text-tertiary)" }}>
              By tapping any &ldquo;Continue&rdquo; button, you agree to HUBB&apos;s{" "}
              <Link href="/terms" className="underline" style={{ color: "var(--text-secondary)" }}>Terms</Link> and{" "}
              <Link href="/privacy" className="underline" style={{ color: "var(--text-secondary)" }}>Privacy Policy</Link>.
            </p>
          )}
