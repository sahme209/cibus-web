...
const FOOTER_LINKS = {
  ...
  "Partner With Us": [
    { label: "Restaurants", href: "/partner/restaurants" },
    { label: "Riders", href: "/partner/riders" },
    { label: "Merchants", href: "/partner/merchants" },
  ],
};
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-lg text-white text-sm font-medium w-full transition-opacity hover:opacity-80"
