      ...
      <div className="px-6 py-5 flex items-center justify-between relative z-10">
        ...
        {promo.code && (
          <button
            ...
            className="shrink-0 ml-4 group"
          >
            <div
              className="px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all group-hover:scale-105 group-active:scale-95"
              style={{
